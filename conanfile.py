...
class HomedbConan(ConanFile):
    name = "homedb"
    version = "4.0.10"

    homepage = "https://github.com/hkadayam/HomeDB"
    description = "HomeDB Database engine"
    topics = ("ebay", "nublox")
    url = "https://github.com/hkadayam/HomeDB"
    license = "Apache-2.0"
